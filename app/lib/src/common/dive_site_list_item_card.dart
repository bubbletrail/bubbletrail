          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    if (site.bodyOfWater != null && site.bodyOfWater!.isNotEmpty) ...[
                      _InfoChip(icon: Icons.water, label: site.bodyOfWater!, theme: theme),
                      const SizedBox(width: 12),
                    ],
                    if (site.difficulty != null && site.difficulty!.isNotEmpty) ...[
