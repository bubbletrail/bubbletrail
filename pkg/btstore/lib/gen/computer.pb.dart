...
class Computer extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Computer', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
        ...
        ..a<$core.List<$core.int>>(7, _omitFieldNames ? '' : 'ldcFingerprint', $pb.PbFieldType.OY)
        ..aOM<$1.Timestamp>(8, _omitFieldNames ? '' : 'lastLogDate', subBuilder: $1.Timestamp.create)
