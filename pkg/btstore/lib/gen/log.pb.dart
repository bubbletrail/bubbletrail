...
class Log extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Log', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
        ...
        ..aD(5, _omitFieldNames ? '' : 'maxDepth')
        ..aD(6, _omitFieldNames ? '' : 'avgDepth')
        ..aD(7, _omitFieldNames ? '' : 'surfaceTemperature')
        ..aD(8, _omitFieldNames ? '' : 'minTemperature')
        ..aD(9, _omitFieldNames ? '' : 'maxTemperature')
        ..aOM<Salinity>(10, _omitFieldNames ? '' : 'salinity', subBuilder: Salinity.create)
        ..aD(11, _omitFieldNames ? '' : 'atmosphericPressure')
        ..aE<DiveMode>(12, _omitFieldNames ? '' : 'diveMode', enumValues: DiveMode.values)
        ..aOM<DecoModel>(13, _omitFieldNames ? '' : 'decoModel', subBuilder: DecoModel.create)
        ..aOM<$1.Position>(14, _omitFieldNames ? '' : 'position', subBuilder: $1.Position.create)
        ..pPM<GasMix>(15, _omitFieldNames ? '' : 'gasMixes', subBuilder: GasMix.create)
        ..pPM<Tank>(16, _omitFieldNames ? '' : 'tanks', subBuilder: Tank.create)
        ..pPM<LogSample>(17, _omitFieldNames ? '' : 'samples', subBuilder: LogSample.create)
        ..a<$core.List<$core.int>>(18, _omitFieldNames ? '' : 'ldcFingerprint', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(5)
  void clearMaxDepth() => $_clearField(5);
  ...
  @$pb.TagNumber(6)
  void clearAvgDepth() => $_clearField(6);
  ...
  @$pb.TagNumber(7)
  void clearSurfaceTemperature() => $_clearField(7);
  ...
  @$pb.TagNumber(10)
  set salinity(Salinity value) => $_setField(10, value);
  @$pb.TagNumber(10)
  $core.bool hasSalinity() => $_has(9);
  @$pb.TagNumber(10)
  void clearSalinity() => $_clearField(10);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  void clearAtmosphericPressure() => $_clearField(11);

  @$pb.TagNumber(12)
  DiveMode get diveMode => $_getN(11);
  @$pb.TagNumber(12)
  set diveMode(DiveMode value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasDiveMode() => $_has(11);
  @$pb.TagNumber(12)
  void clearDiveMode() => $_clearField(12);

  @$pb.TagNumber(13)
  DecoModel get decoModel => $_getN(12);
  @$pb.TagNumber(13)
  set decoModel(DecoModel value) => $_setField(13, value);
  @$pb.TagNumber(13)
  $core.bool hasDecoModel() => $_has(12);
  @$pb.TagNumber(13)
  void clearDecoModel() => $_clearField(13);
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(18)
  void clearLdcFingerprint() => $_clearField(18);
...
class LogSample extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'LogSample', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class Salinity extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Salinity', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class GasMix extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'GasMix', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class Tank extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Tank', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class DecoModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'DecoModel', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class TankPressure extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'TankPressure', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class Ppo2Reading extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'Ppo2Reading', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class DecoStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'DecoStatus', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class SampleEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'SampleEvent', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
...
class VendorData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i =
      $pb.BuilderInfo(_omitMessageNames ? '' : 'VendorData', package: const $pb.PackageName(_omitMessageNames ? '' : 'btstore'), createEmptyInstance: create)
