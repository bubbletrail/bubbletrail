...
enum parser_sample_event_t {
  ...
  /// Deprecated: replaced by DC_SAMPLE_BEARING.
...
final class dc_salinity_t extends ffi.Struct {
  ...
  dc_water_t get type => dc_water_t.fromValue(typeAsInt);
...
final class dc_gasmix_t extends ffi.Struct {
  ...
  dc_usage_t get usage => dc_usage_t.fromValue(usageAsInt);
}
...
final class dc_tank_t extends ffi.Struct {
  ...
  dc_tankvolume_t get type => dc_tankvolume_t.fromValue(typeAsInt);
...
final class dc_decomodel_t extends ffi.Struct {
  ...
  dc_decomodel_type_t get type => dc_decomodel_type_t.fromValue(typeAsInt);

  @ffi.Int()
  external int conservatism;

  external UnnamedUnion params;
}
...
final class dc_sample_value_t extends ffi.Union {
  ...
  external UnnamedStruct pressure;

  @ffi.Double()
  external double temperature;

  external UnnamedStruct$1 event;
  ...
  external UnnamedStruct$2 vendor;

  @ffi.Double()
  external double setpoint;

  external UnnamedStruct$3 ppo2;

  @ffi.Double()
  external double cns;

  external UnnamedStruct$4 deco;
